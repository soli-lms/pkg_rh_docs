Donnez l'empathie personnalisée à ce pkg_gestion_utilisateurs qui existe dans le (Package 6 : Gestion des Utilisateurs) pour cette application (Soli-LMS) pour responsable de formation. 
donner les parties: 
- Ce qu'il dit.
- Ce qu'il fait.
- Ce qu'il ressent.
